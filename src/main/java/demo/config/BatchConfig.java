...
import demo.batch.JobCompletionNotificationListener;
import demo.batch.PassThroughLineAggregator;
...
public class BatchConfig {
	...
	@Bean
	public Job inportUserJob(JobCompletionNotificationListener listener, Step step1) {
